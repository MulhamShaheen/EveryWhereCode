...
var calendar = new Vue({
    ...
    mounted() {
        ...
        fetch('/api/sql.php',
            ...
            this.myEvent.name = this.items[this.curEvent].name;
            this.myEvent.month = this.items[this.curEvent].month;
            this.myEvent.day = this.items[this.curEvent].mday;
            this.myEvent.place = this.items[this.curEvent].place;
