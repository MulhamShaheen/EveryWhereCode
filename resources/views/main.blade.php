...
{{--    <link rel="stylesheet" href="/js/main.js?<?=filectime("js/main.js")?>">--}}
    <script src="https://cdn.jsdelivr.net/npm/vue@2/dist/vue.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/gsap.min.js"></script>
</head>
<header>
    <div class="header">
        <a style="all: unset" href="{{ route('home') }}">
            <div class="title" id="app"><h1>MyApp</h1></div>
        </a>
        <div class="mainmenu">
            <div class="button-menu hvr-fade">
                <h4 style="display: flex; align-items: center">Test</h4>
            </div>

            <div class="button-menu hvr-fade">
                <a style="all: unset; align-self: center" href="{{ route('home') }}">
                    <h4 style="display: flex; align-items: center">Home</h4>
                </a>
            </div>
            <div class="button-menu hvr-fade">
                <h4 style="display: flex; align-items: center">Test</h4>
